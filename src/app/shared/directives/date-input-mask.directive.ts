 ...
 * foco (bug encontrado em produção no NimbusFlowWeb), mesmo sem a máscara (digitar a segunda data
 * manualmente inteira tem o mesmo problema). Por isso os campos "range" continuam usando
