...
export class NoCreditOrderLegacyDialogComponent implements OnChanges {
  @Input() visible = false;
  @Input() applying = false;
  @Input() preview: NoCreditOrderLegacyPreviewResult | null = null;
  ...
  protected readonly selectedCandidates = signal<NoCreditOrderLegacyCandidate[]>([]);
