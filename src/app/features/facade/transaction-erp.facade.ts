...
import { TransactionsErpModel, TransactionsErpTotalsModel } from '@models/transactions-erp.models';
...
export class TransactionsErpFacade {
  ...
  private readonly _totals = signal<TransactionsErpTotalsModel | null>(null);
