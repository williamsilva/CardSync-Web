...
import { ContractAuditApiModel } from '@models/contract-audit.models';
...
import { ContractAuditApiService } from '@features/service/contract-audit.api.service';

type LastQuery = ListQueryDto<ContractAuditAdvancedFilters>;

@Injectable({ providedIn: 'root' })
export class ContractAuditFacade {
  private readonly api = inject(ContractAuditApiService);
  ...
  private readonly _data = signal<ContractAuditApiModel[]>([]);
