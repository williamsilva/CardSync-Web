...
export interface TransactionsErpInstallmentFiltersState {
  tid: string;
  cvNsu: string;
...
export type TransactionsErpInstallmentAdvancedFilters =
  Partial<TransactionsErpInstallmentFiltersState>;

export type TransactionsErpInstallmentAdvancedFilterSignals = {
  [K in keyof TransactionsErpInstallmentFiltersState]: WritableSignal<
    TransactionsErpInstallmentFiltersState[K]
  >;
};

export function createEmptyTransactionsErpInstallmentFiltersState(): TransactionsErpInstallmentFiltersState {
  return {
    tid: '',
    cvNsu: '',
    authorization: '',
...
export function resetTransactionsErpInstallmentAdvancedFilters(
  filters: TransactionsErpInstallmentAdvancedFilterSignals,
): void {
  const empty = createEmptyTransactionsErpInstallmentFiltersState();
