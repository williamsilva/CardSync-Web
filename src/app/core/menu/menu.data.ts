...
export const APP_MENU: AppMenuItem[] = [
  ...
  /* Register */
  {
    ...
    children: [
      ...
      {
        labelKey: 'menu.register.holidays',
        icon: 'pi pi-calendar text-orange-400',
        route: '/register/holidays',
        exact: false,
        permissions: [PERMISSIONS.SUPPORT, PERMISSIONS.HOLIDAYS.VIEW],
      },
      {
        labelKey: 'menu.register.banks',
        icon: 'pi pi-building-columns text-orange-400',
        route: '/register/banks',
        exact: false,
        permissions: [PERMISSIONS.SUPPORT, PERMISSIONS.BANKS.VIEW],
      },
      {
        labelKey: 'menu.register.bankingDomicile',
        icon: 'pi pi-credit-card text-orange-400',
        route: '/register/banking-domicile',
        exact: false,
        permissions: [PERMISSIONS.SUPPORT, PERMISSIONS.BANKING_DOMICILE.VIEW],
      },
      {
        labelKey: 'menu.register.noFileDay',
        icon: 'pi pi-calendar-times text-orange-400',
        route: '/register/no-file-day',
        exact: false,
        permissions: [PERMISSIONS.SUPPORT, PERMISSIONS.NO_FILE_DAY.VIEW],
      },
    ],
  },
  /* File Processing — cor blue */
  {
    ...
    children: [
      ...
      {
        labelKey: 'menu.file.processing.analysis',
        icon: 'pi pi-chart-bar text-blue-400',
        route: '/file-processing/analysis',
        exact: false,
        permissions: [PERMISSIONS.SUPPORT, PERMISSIONS.COMPANIES.VIEW],
      },
      {
